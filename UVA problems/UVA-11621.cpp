...
void solve()    {
    ...
    ll l, l1, l2, r1, r2, M, N, O, P, m = 0, val = 0, num = 0, n = 0, o = 0, p = 0, q = 0, r, i, j, k, count = 0, sum = 0, min = LONG_MAX, max = LONG_MIN, index = 0, diff;
    ...
    deque <ll> dq, iq, eq, odd, even, cnt(0, 0), chk, ans, ffloor, fceil;

    deque <pair <ll, ll>> pdq, qdq, rows, coloumns;
